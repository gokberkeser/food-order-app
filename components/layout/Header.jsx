...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto sm:text-white flex justify-between items-center h-full">
        <Logo />
        <nav
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <a href="#">
            <FaSearch onClick={() => {setIsSearchModal(true)}} className=" hover:text-primary cursor-pointer transition-all"/>
          </a>
